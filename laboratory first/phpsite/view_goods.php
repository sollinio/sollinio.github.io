...
$result = mysql_query ("SELECT * FROM goods WHERE id='$id'",$db); /*ВЫБРАТЬ поля .. ИЗ таблицы .. ГДЕ .. */
...
<br \>
<div class='price'>Цена:<div class='priceZ'><?php echo $myrow['price']; ?></div> руб. за 1 шт. 
<br \>
</div>
<br \>
...
<br \>
<br \>
<p><a class="goods-sold" href="link.php" target="_self">Как купить?</a></p>
<br \>
</div><!-- Закрываем -->
