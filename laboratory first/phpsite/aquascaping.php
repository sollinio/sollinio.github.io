...
$result = mysql_query ("SELECT title, meta_d, meta_k, text FROM settings WHERE page='aquascaping'",$db); /*ВЫБРАТЬ поля .. ИЗ таблицы .. ГДЕ .. */
...
<div class='cont-tex'>
<?php
$result = mysql_query ("SELECT id, title,description,category FROM articles WHERE pick	='4'",$db);
