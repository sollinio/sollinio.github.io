...
$result = mysql_query ("SELECT title, meta_d, meta_k, text FROM settings WHERE page='ground'",$db); /*ВЫБРАТЬ поля .. ИЗ таблицы .. ГДЕ .. */
...
<div class='cont-tex'>
<?php
$result = mysql_query ("SELECT id, title,description,category,price FROM goods WHERE pick ='9'",$db);
